exports.up = async function up(knex) {
  ...
  await knex.schema.createTable("products", (table) => {
    ...
    table.uuid("group_id").references("id").inTable("product_groups").onDelete("SET NULL");
  ...
  await knex.schema.raw("create index products_internal_code_index on products (internal_code)");
