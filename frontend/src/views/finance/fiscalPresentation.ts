...
const fiscalReadinessIssueLabelPatterns = [
  ...
  { label: 'Natureza operação', pattern: /natureza da operacao padrao/i },
  { label: 'CFOP padrão venda', pattern: /cfop padrao de venda/i },
  { label: 'CST ICMS padrão', pattern: /cst\/csosn icms padrao/i },
  { label: 'CST PIS padrão', pattern: /cst pis padrao/i },
  { label: 'CST COFINS padrão', pattern: /cst cofins padrao/i },
